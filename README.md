...
**python compute_accuracy.py "path to CVAR dataset"**  </br>
...
Additionally, for visualizing the manually annotated visible fingertips as well as all the visible and non-visible fingertips extracted from the **joint.txt** file in the original CVAR dataset, use the following: <br />

1) visualize all the visible and non-visible fingertips: **python vis_all_fingertips.py "path to CVAR dataset"** <br />
2) visualize only the visible fingertips: **python vis_visible_fingertips.py "path to CVAR dataset"** <br />
